...
export function LeadOverviewTab({ lead }: LeadOverviewTabProps) {
  ...
  return (
    ...
    <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 md:gap-6">
      {/* Lead Summary Card */}
      <Card className="shadow-sm border-l-4 border-blue-500 dark:border-blue-400">
        <CardHeader className="pb-3 pt-4 px-4 sm:px-6">
      ...
      <Card className="shadow-sm border-l-4 border-green-500 dark:border-green-400">
        <CardHeader className="pb-3 pt-4 px-4 sm:px-6">
      ...
      <Card className="shadow-sm border-l-4 border-yellow-500 dark:border-yellow-400">
        <CardHeader className="pb-3 pt-4 px-4 sm:px-6">
      ...
      <Card className="shadow-sm border-l-4 border-purple-500 dark:border-purple-400">
        <CardHeader className="pb-3 pt-4 px-4 sm:px-6">
