...
-- CreateEnum
CREATE TYPE "KnockStatus" AS ENUM ('Not Visited', 'KNOCKED', 'No Answer', 'INTERESTED', 'Appointment Set');
...
CREATE TABLE "VisionMarker" (
    ...
    "notes" TEXT,
    "status" "KnockStatus" NOT NULL DEFAULT 'Not Visited',
    "contactInfo" JSONB,
    "visits" JSONB,
    "followUp" JSONB,
    "userId" UUID,
...
-- CreateIndex
CREATE INDEX "idx_appointments_lead_id" ON "Appointment"("leadId");
